...
public class EarthAndManMuseumActivity extends AppCompatActivity {
    ListView list;
    Integer[] imgid = {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_earth_and_man_museum);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                callIntent.setData(Uri.parse("tel:+35928656639"));
        ...
        final String[] items = getResources().getStringArray(R.array.earth);
