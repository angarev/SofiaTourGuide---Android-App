...
public class RussianChurchActivity extends AppCompatActivity {
    ListView list;
    Integer[] imgid = {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_russian_church);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                callIntent.setData(Uri.parse("tel:+35929862715"));
        ...
        final String[] items = getResources().getStringArray(R.array.russian);
