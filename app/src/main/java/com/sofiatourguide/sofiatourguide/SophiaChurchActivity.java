...
public class SophiaChurchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sophia_church);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                callIntent.setData(Uri.parse("tel:+35929870971"));
        ...
        final String[] items = getResources().getStringArray(R.array.sofia);
