...
public class ParaskevaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_paraskeva);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                callIntent.setData(Uri.parse("tel:+35929831963"));
        ...
        final String[] items = getResources().getStringArray(R.array.paraskeva);
