    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (position) {
                    case 0:
                        Intent i = new Intent(getApplicationContext(), SaintSophiaActivity.class);
                        i.putExtra("id", position);
                        startActivity(i);
                        break;
                    case 1:
                        Intent i1 = new Intent(getApplicationContext(), BattenbergMausoleumActivity.class);
                    ...
                    case 5:
                        ...
                        break;
                    case 6:
                        Intent i6 = new Intent(getApplicationContext(), IvanVazovActivity.class);
