...
public class SofiaSynagogueActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sofia_synagogue);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                callIntent.setData(Uri.parse("tel:+359988878806"));
        ...
        final String[] items = getResources().getStringArray(R.array.synagogue);
