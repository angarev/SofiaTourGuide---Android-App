...
public class BasilicaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                callIntent.setData(Uri.parse("tel:+35924164077"));
        ...
        final String[] items = getResources().getStringArray(R.array.basilica);
