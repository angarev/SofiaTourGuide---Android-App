...
public class ContemporaryArtActivity extends AppCompatActivity {
    ListView list;
    Integer[] imgid = {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_contemporary_art);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                callIntent.setData(Uri.parse("tel:+359879834030"));
        ...
        final String[] items = getResources().getStringArray(R.array.contemporary);
